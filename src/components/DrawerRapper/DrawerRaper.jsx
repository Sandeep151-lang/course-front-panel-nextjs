...
const DrawerWrapper = ({ title,open=false,setOpen,footer, children, modalFooter, width = "max-w-3xl", titleButton ,onClose}) => {
              ...
              >
                <Dialog.Panel className= { `pointer-events-auto relative w-screen ${width}` }>
                  ...
                  <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                    ...
                    {modalFooter && (
                      <>
                    <div className="relative mt-6 flex-1 px-4 sm:px-6">{modalFooter}</div>
